                                ...
                                <div class="col-12">
                                    <div class="row align-items-center">
                                        <div class="col-lg-2 col-md-2 col-sm-4">
                                            ...
                                            <select wire:model="paginate" name="paginate" id="paginate" class="form-control form-control-sm" style="width:40%;">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="dropdown">
                                                        <button class="btn btn-danger dropdown-toggle" data-toggle="dropdown">Columns</button>
                                                        <div class="dropdown-menu">
                                                            @foreach($columns as $column)
                                                            <li><input type="checkbox" wire:model="selectedColumns" value="{{$column}}"><label style="color:black;font-size:12px;">{{$column}}</label></li>
                                                            @endforeach
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-6">
                                                    @if ($checked)
                                                    <div class="dropdown">
                                                        <button class="btn btn-danger dropdown-toggle" data-toggle="dropdown">With Checked ({{ count($checked) }})</button>
                                                        <div class="dropdown-menu">
                                                            <a href="#" class="dropdown-item" type="button" onclick="confirm('Are you sure you want to delete these Records?') || event.stopImmediatePropagation()" wire:click="deleteRecords()">Delete</a>
                                                            <a href="#" class="dropdown-item" type="button" onclick="confirm('Are you sure you want to export these Records?') || event.stopImmediatePropagation()" wire:click="exportSelected()">CSV</a>
                                                            <a href="#" class="dropdown-item" type="button" onclick="confirm('Are you sure you want to export these Records?') || event.stopImmediatePropagation()" wire:click="excelSelected()">Excel</a>
                                                        </div>
                                                    </div>
                                                    @endif
                                                </div>
                            ...
                            <div class="row mt-3">
                                <div class="col-6 mb-3" style="text-align: left;">
                                    <form action="{{ route('contact.import') }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <button class="btn btn-sm btn-success">Import Contacts</button>
                                    </form>
                                </div>

                                <div class="col-6 mb-3">
                                    @can('contact-create')
                                    <a href="{{ route('contact.create') }}" class="btn btn-sm btn-success float-right">Add Contact</a>
                                    @endcan
                                </div>
                            </div>
                            ...
                            <div class="table-responsive text-nowrap">
                                <table class="table table-striped table-sortable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="@if ($this->isChecked($contact->id))table-primary
                                    @endif">
